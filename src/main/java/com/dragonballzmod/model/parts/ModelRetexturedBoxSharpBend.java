...
public class ModelRetexturedBoxSharpBend extends ModelBox {
    ...
    public void createCubeQuads(ModelRenderer par1ModelRenderer, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10, int topX, int topY, int botX, int botY) {
        ...
        float distanceMulti = 1.24F;

        float distanceMultiInner = 0.94F;

        PositionTextureVertex positiontexturevertex = new PositionTextureVertex(par4, par5 - this.upperRotation * distanceMultiInner, par6, 0.0F, 0.0F);
        PositionTextureVertex positiontexturevertex1 = new PositionTextureVertex(f4, par5 - this.upperRotation * distanceMultiInner, par6, 0.0F, 8.0F);
        PositionTextureVertex positiontexturevertex2 = new PositionTextureVertex(f4, f5 + this.lowerRotation * distanceMultiInner, par6, 8.0F, 8.0F);
        PositionTextureVertex positiontexturevertex3 = new PositionTextureVertex(par4, f5 + this.lowerRotation * distanceMultiInner, par6, 8.0F, 0.0F);
        PositionTextureVertex positiontexturevertex4 = new PositionTextureVertex(par4, par5 + this.upperRotation * distanceMulti, f6, 0.0F, 0.0F);
        PositionTextureVertex positiontexturevertex5 = new PositionTextureVertex(f4, par5 + this.upperRotation * distanceMulti, f6, 0.0F, 8.0F);
        PositionTextureVertex positiontexturevertex6 = new PositionTextureVertex(f4, f5 - this.lowerRotation * distanceMulti, f6, 8.0F, 8.0F);
        PositionTextureVertex positiontexturevertex7 = new PositionTextureVertex(par4, f5 - this.lowerRotation * distanceMulti, f6, 8.0F, 0.0F);
