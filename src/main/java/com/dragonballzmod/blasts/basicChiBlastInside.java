package com.dragonballzmod.blasts;
...
/**
 * Created by liam on 29/01/2015.
 */
public class basicChiBlastInside extends EntityFireball {
        ...
        public basicChiBlastInside(World par1World) {
            super(par1World);
        ...
        public basicChiBlastInside(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
            super(par1World, par2, par4, par6, par8, par10, par12);
        }

        public basicChiBlastInside(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par5, double par7) {
