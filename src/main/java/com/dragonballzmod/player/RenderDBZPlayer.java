...
public class RenderDBZPlayer extends RenderPlayer {
    ...
    public ModelDBZBiped modelBipedMain;
    public ModelDBZBiped modelArmorChestplate;
    public ModelDBZBiped modelArmor;
   // private ModelDBZBiped modelSkinOverlay;
   private static final ResourceLocation saiyanTail = new ResourceLocation("dragonballzmod:textures/accessories/tailModel.png");

    private static final ResourceLocation namekEars = new ResourceLocation("dragonballzmod:textures/accessories/namekExtras.png");

    private boolean isRenderingFirstPerson = false;

    private ModeltailModel modelTail;

    private ModelNamek modelNamekEars;

    public RenderDBZPlayer() {
        this(new ModelDBZBiped(0.0F), 0.5F);
        this.modelBipedMain = (ModelDBZBiped) this.mainModel;
        this.modelArmorChestplate = new ModelDBZBiped(1.0F);
        this.modelArmor = new ModelDBZBiped(0.5F);

        //this.modelSkinOverlay = new ModelDBZBiped(0.001F);
        modelTail = new ModeltailModel();
        modelNamekEars = new ModelNamek();
    }

    public RenderDBZPlayer(ModelBase p_i1261_1_, float p_i1261_2_) {
    ...
    protected int shouldRenderPass(AbstractClientPlayer p_77032_1_, int p_77032_2_, float p_77032_3_) {
        ...
        if (itemstack != null) {
            ...
            if (item instanceof ItemArmor) {
                ...
                ModelDBZBiped modelbiped = p_77032_2_ == 2 ? this.modelArmor : this.modelArmorChestplate;
                ...
                modelbiped = (ModelDBZBiped) net.minecraftforge.client.ForgeHooksClient.getArmorModel(p_77032_1_, itemstack, p_77032_2_, modelbiped);
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (p_77036_1_.getDataWatcher().getWatchableObjectString(21).equals("Saiyan")){
            ...
            modelTail.lowerBodyTrack.rotationPointX = this.modelBipedMain.bipedLowerBody.rotationPointX;
            modelTail.lowerBodyTrack.rotationPointY = this.modelBipedMain.bipedLowerBody.rotationPointY;
            modelTail.lowerBodyTrack.rotationPointZ = this.modelBipedMain.bipedLowerBody.rotationPointZ;

            modelTail.lowerBodyTrack.rotateAngleX = this.modelBipedMain.bipedLowerBody.rotateAngleX;
            modelTail.lowerBodyTrack.rotateAngleY = this.modelBipedMain.bipedLowerBody.rotateAngleY;
            modelTail.lowerBodyTrack.rotateAngleZ = this.modelBipedMain.bipedLowerBody.rotateAngleZ;

            modelTail.updateRotations();
        ...
        if (p_77036_1_.getDataWatcher().getWatchableObjectString(21).equals("Namekian")) {
            ...
            modelNamekEars.bipedHeadTracker.rotationPointZ = this.modelBipedMain.bipedHead.rotationPointZ;

            modelNamekEars.bipedHeadTracker.rotateAngleX = this.modelBipedMain.bipedHead.rotateAngleX;
            modelNamekEars.bipedHeadTracker.rotateAngleY = this.modelBipedMain.bipedHead.rotateAngleY;
            modelNamekEars.bipedHeadTracker.rotateAngleZ = this.modelBipedMain.bipedHead.rotateAngleZ;

            modelNamekEars.bipedHeadTracker.render(0.0625F);
            this.bindEntityTexture(p_77036_1_);
        }
    }
        ...
        if (p_77029_1_.getCommandSenderName().endsWith("liam3011")) {
         ...
         //   this.modelSkinOverlay.bipedHead.rotateAngleX = this.modelBipedMain.bipedHead.rotateAngleX;
          ...
          //  this.modelSkinOverlay.bipedHead.render(0.0625F);
            ...
            //this.bindTexture(new ResourceLocation("narutomod:textures/gayfolderliammade/sakuraParticle.png"));
