package com.dragonballzmod.entity.projectiles;
...
public class EntityKiBlast extends Entity // TODO actually code the water bullet and change it from being a fireball
{
    ...
    //public int kiBlastGrowth = 0;

    //public int kiBlastMaxGrowth = 120;

    //public int kiBlastRotation;

    public EntityKiBlast(World par1World) {
        super(par1World);
        this.setSize(0.3F, 0.3F);
    }

    @SideOnly(Side.CLIENT)
    public EntityKiBlast(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
        super(par1World);
    ...
    public EntityKiBlast(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par5, double par7) {
        super(par1World);
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition) {
        ...
        // spawn explode particles and stuff here, also calculate damage and blocks to remove

        /*for (int i = 0; i < 100; ++i) {
            // not a particle yet but its an example
            this.worldObj.spawnParticle("kiblast", this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, this.posY + this.height / 2 + (double) (this.rand.nextFloat() * this.height), this.posZ + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, 0, 0, 0);
        }*/

        //this.playSound("dragonballzmod.kiexplosion", 0.6F, 1.0F);
    ...
    public void onUpdate() {
        ...
        if (this.ticksInAir == 4) {
            //this.playSound("dragonballzmod.kiblast", 0.4F, 1.0F);
        }
        ...
        if (life-- <= 0) {
            // TODO make the blast explode here or fizz out
            this.setDead();
        }
    }
    ...
    private void updateMovement() {
        if (!this.worldObj.isRemote && (this.shootingEntity != null && this.shootingEntity.isDead || !this.worldObj.blockExists((int) this.posX, (int) this.posY, (int) this.posZ))) {
            ...
            this.worldObj.spawnParticle("kiblasttrail", this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
            this.setPosition(this.posX, this.posY, this.posZ);
        }
    }
