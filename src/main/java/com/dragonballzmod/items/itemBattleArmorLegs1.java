...
import com.dragonballzmod.model.parts.modelBattleArmorLegs1;
...
public class itemBattleArmorLegs1 extends ItemArmor {

    @SideOnly(Side.CLIENT)
    private IIcon[] Icons;

    public itemBattleArmorLegs1(ArmorMaterial par2EnumArmorMaterial,
                                     int par3, int par4) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        return DragonBallZMod.modid + ":textures/armour/shinobiLeggings.png";
    }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving,
        ...
        modelBattleArmorLegs1 armorModel = null;
        if (itemStack != null) {
            if (itemStack.getItem() instanceof itemBattleArmorLegs1) {
                int type = ((ItemArmor) itemStack.getItem()).armorType;

                if (type == 2) {
                    armorModel = new modelBattleArmorLegs1(); // change to the flak jacket model
