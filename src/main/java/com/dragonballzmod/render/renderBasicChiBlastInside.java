package com.dragonballzmod.render;


import com.dragonballzmod.blasts.basicChiBlastInside;
import com.dragonballzmod.client.PlayerRenderTickEvent;
import com.dragonballzmod.model.parts.modelBasicChiBlastInside;
...
public class renderBasicChiBlastInside extends Render {

        private static final ResourceLocation entityTexture = new ResourceLocation("dragonballzmod:textures/blasts/basicChiBlastInside.png");

        private ModelBase mainModel;

        private float field_77002_a;

        public renderBasicChiBlastInside() {
            this.mainModel = new modelBasicChiBlastInside();
        }
        ...
        private void renderEntityOnFire(Entity par1Entity, double par2, double par4, double par6, float par8) {
            ...
            basicChiBlastInside entityFireball = (basicChiBlastInside) par1Entity;
        ...
        public void doRenderFireball(basicChiBlastInside par1EntityFireball, double par2, double par4, double par6, float par8, float par9) {
            ...
            while (delta-- >= 1) {
                ...
                ++par1EntityFireball.fireballRotation;
            }
        ...
        public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
            this.doRenderFireball((basicChiBlastInside) par1Entity, par2, par4, par6, par8, par9);
        }
    }
